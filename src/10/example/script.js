...
function addInput() {
    ...
    var indicator = color.querySelector('.color-mixer .indicator');
...
// 3. 把其他两个颜色框也加上事件。
var addRedInput = document.querySelector('.red .body input');
addRedInput.addEventListener('change', addInput);

var addGreenInput = document.querySelector('.green .body input');
addGreenInput.addEventListener('change', addInput);

var addBlueInput = document.querySelector('.blue .body input');
addBlueInput.addEventListener('change', addInput);